...
Lower-level detail belongs in the work item `spec.md` and the plan file generated by `work-item-plan` (e.g., `plan.autonomous.md` / `plan.interactive.md`, or legacy `plan.md`).
